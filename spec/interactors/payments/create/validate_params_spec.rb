...
RSpec.describe Payments::Create::ValidateParams do
  ...
  describe '.call' do
    context 'with valid params' do
      ...
      it 'provides the friendship' do
        expect(context.friendship).to eq(friendship)
        expect(context.friendship.association(:user)).to be_loaded
        expect(context.friendship.association(:friend)).to be_loaded
      end
    end
